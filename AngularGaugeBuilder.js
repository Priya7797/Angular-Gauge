	...
	template.innerHTML = `
		<form id="form">
			<table>
				...
				<td><input type="text" id="fmin1" name="min1"></td><br>
				<td><label for="fmax1">Maximum Value:</label></td>
				<td><input type="text" id="fmax1" name="max1"></td><br>
				...
				<td><input type="text" id="fmin2" name="min2"></td><br>
				<td><label for="fmax2">Maximum Value:</label></td>
				<td><input type="text" id="fmax2" name="max2"></td><br>
				<td><label for="factual2">Actual Value:</label></td>
				<td><input type="text" id="factual2" name="actual2"></td><br>
				</tr>
