	...
	template.innerHTML = `
		<form id="form">
			<table>
				...
				<tr><td><label for="fmin1">Minimum Value:</label></td>
				<td><input type="text" id="fmin1" name="min1"></td></tr><br>
				<tr><td><label for="fmax1">Maximum Value:</label></td>
				<td><input type="text" id="fmax1" name="max1"></td></tr><br>
				<tr><td><label for="factual1">Actual Value:</label></td>
				<td><input type="text" id="factual1" name="actual1"></td><br>
				</tr>

				<tr>
				<td> <B>Measurement 2 </B></td><br></tr>
				<tr><td><label for="fmin2">Minimum Value:</label></td>
				<td><input type="text" id="fmin2" name="min2"></td></tr><br>
				<tr><td><label for="fmax2">Maximum Value:</label></td>
				<td><input type="text" id="fmax2" name="max2"></td></tr><br>
